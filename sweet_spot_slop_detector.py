#!/usr/bin/env python3
"""
Sweet Spot Slop Detector - Balanced Approach

This version finds the sweet spot between aggressive slop detection and avoiding false positives
by combining research-based information density analysis with smart pattern detection.
"""
...
class SweetSpotSlopDetector:
    ...
    def detect_slop(self, text: str) -> Dict[str, Any]:
        """Detect slop using sweet spot approach."""
        ...
        # Sweet spot weights - balanced approach
        weights = {
            "information_density": 0.30,  # Research-based dimension
            ...
            "hedging": 0.03,
            "sycophancy": 0.02,
            "repetition": 0.01,  # Low weight to avoid false positives
            "structure": 0.01,  # Low weight to avoid false positives
        }
        ...
        # Sweet spot threshold - balanced approach
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Sweet Spot AI Slop Detection Tool",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python sweet_spot_slop_detector.py "This is high-quality technical content."
  python sweet_spot_slop_detector.py --file document.txt
  python sweet_spot_slop_detector.py --json "AI-generated slop text here"
  python sweet_spot_slop_detector.py --test  # Run test cases
        """,
    )
    ...
    # Initialize detector
    detector = SweetSpotSlopDetector()

    if args.test:
        # Run test cases
        print("🧪 Sweet Spot Slop Detection Test Cases")
        print("=" * 60)
        ...
        print(
            f"🎯 Sweet spot detector shows {'excellent' if accuracy >= 95 else 'good' if accuracy >= 90 else 'moderate'} performance"
        )
    ...
    try:
        ...
        if args.json:
            ...
            print("\n🔍 Sweet Spot Slop Detection Analysis")
            print("=" * 50)
