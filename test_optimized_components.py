...
class TestOptimizedNLPPipeline:
    ...
    def test_lazy_loading(self):
        ...
        nlp = pipeline.nlp
        assert nlp is not None or pipeline._nlp is None  # May be None if spaCy not available
...
class TestEnsembleDetector:
    ...
    def test_model_save_load(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='_combiner.pkl', delete=False) as tmp_file1, \
             tempfile.NamedTemporaryFile(suffix='_anomaly.pkl', delete=False) as tmp_file2:
